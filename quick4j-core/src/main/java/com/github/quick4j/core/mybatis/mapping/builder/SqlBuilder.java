...
public class SqlBuilder {
  ...
  public String buildSelectListSql(Map<String, Object> parameter) {
    ...
    String sql = new SQL() {{
      ...
      if (null != queriedParams) {
        List<EntityPersistentInfo.MappedColumn>
            mappedColumns =
            entityPersistentInfo.getMappedColumns();
  ...
  public String buildInsertSql(final BaseEntity entity) {
    EntityPersistentInfo entityPersistentInfo = EntityAssistant.parse(entity.getClass());
    final String tableName = entityPersistentInfo.getTableName();
    final List<EntityPersistentInfo.MappedColumn>
        mappedColumns =
        entityPersistentInfo.getMappedColumns();
  ...
  public String buildUpdateByIdSql(final BaseEntity entity) {
    EntityPersistentInfo entityPersistentInfo = EntityAssistant.parse(entity.getClass());
    final String tableName = entityPersistentInfo.getTableName();
    final List<EntityPersistentInfo.MappedColumn>
        mappedColumns =
  ...
  public String buildDeleteByParameters(final BaseEntity entity) {
    ...
    String sql = new SQL() {{
      ...
      if (entity.getId() != null) {
        ...
        String
            whereString =
            StringUtils.arrayToDelimitedString(whereList.toArray(new String[]{}), " and ");
        WHERE(whereString);
      }
